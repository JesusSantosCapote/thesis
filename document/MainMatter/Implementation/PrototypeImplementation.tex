...
En esta primera entrega del prototipo solo se implement\'o a un crawler para PostgreSQL. Su l\'ogica 
...
En la generación de los \'arboles de join \textbf{maximal\_join\_trees\_generator} se apoya en 
